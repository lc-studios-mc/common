...
- `bun test`: run tests
- `bun run typecheck`: run tsc without emitting
...
- Always check types (`bun run typecheck`) after editing a TypeScript file
- Format touched files (`bunx prettier`) before comitting
